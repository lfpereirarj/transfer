                ...
                <div class="column" style="text-align: left;color: #787778;font-size: 16px;line-height: 24px;font-family: Ubuntu,sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);">
                  ...
                  <div style="Margin-left: 20px;Margin-right: 20px;">
                    <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
                      ...
                      <p style="Margin-top: 20px;Margin-bottom: 0;">Informações do contato:
                        <br />
                        <br />
                        <strong>Transfer Escolhido:</strong> {{ $data->transfer }}
                        <br />
                        ...
                        <br />
                        <strong>Horário:</strong> {{ $data->hour }}
                        
                        @if(! $data->departure) 
                        <br />
                        @else 
                        <br />
                        <strong>Embarque:</strong> {{ $data->departure }}
                        @endif
                        ...
                        <strong>Cidade:</strong> {{ $data->city_country }}
                        <br />
                        <strong>Valor Total:</strong> {{ $data->price_total }}
                        <br />
                  ...
                  <div style="Margin-left: 20px;Margin-right: 20px;">
                    <div class="btn btn--flat btn--large" style="Margin-bottom: 20px;text-align: center;">
                      <![if !mso]>
                      <a style="border-radius: 4px;display: inline-block;font-size: 14px;font-weight: bold;line-height: 24px;padding: 12px 24px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #ffffff !important;background-color: #222;font-family: Ubuntu, sans-serif;"
                        href="mailto:{{ $data->email }}">Responder e-mail</a>
                      <![endif]>
                      <!--[if mso]><p style="line-height:0;margin:0;">&nbsp;</p><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="mailto:{{ $data->email }}" style="width:212px" arcsize="9%" fillcolor="#222222" stroke="f"><v:textbox style="mso-fit-shape-to-text:t" inset="0px,11px,0px,11px"><center style="font-size:14px;line-height:24px;color:#FFFFFF;font-family:Ubuntu,sans-serif;font-weight:bold;mso-line-height-rule:exactly;mso-text-raise:4px">Responder e-mail</center></v:textbox></v:roundrect><![endif]-->
                    </div>
                  </div>
